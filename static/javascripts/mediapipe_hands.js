...
const mediapipediv = document.createElement("div");
mediapipediv.className = "mediapipe";
body.appendChild(mediapipediv);
const mediapipevideo = document.createElement("video");
mediapipevideo.className = "input_video";
mediapipevideo.setAttribute("style","display:none;");
mediapipediv.appendChild(mediapipevideo);
...
fetch("http://localhost:4000/api_hands", {
    ...
    var r = $("#result_");
    r.html('<span style="color:whitesmoke; background: rgba(0, 0, 0, 0.4);">' + data.label + "</span>");
    signlangTAction(data.label);
    });
}
